...
echo "  │   ├── CLAUDE.md"
echo "  │   └── config.yaml  ← fill in: Trello board ID and code repo path"
echo "  └── ${PROJECT_NAME}-code/"
echo "      ├── CLAUDE.md"
echo "      └── specs/"
echo ""
echo "Next: open ${PROJECT_NAME}/${PROJECT_NAME}-orch/ in Claude Code and run: setup https://trello.com/b/xxxxx/board-name"
